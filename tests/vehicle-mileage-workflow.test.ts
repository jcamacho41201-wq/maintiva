...
describe("vehicle mileage workflow labels", () => {
  ...
  it("keeps Record Inspection visible as an operational action", () => {
    expect(vehiclePage).toContain("Record Inspection");
    expect(vehiclePage).toContain("Inspection date");
    expect(vehiclePage).toContain("Odometer reading");
    expect(vehiclePage).toContain("Services or components inspected");
    expect(vehiclePage).toContain("Recommended work");
    expect(vehiclePage).toContain("Inspection History");
  });
